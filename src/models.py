...
class ModelIMU:
    ...
    def A_c(self,
        ...
        """Get the transition matrix, A, in (6.89)
    ...
    def get_error_G_c(self,
        ...
        """The continous noise covariance matrix, G, in (6.89)
    ...
    def predict_err(self,
        ...
        Hint: This is doing a discrete step of (6.89) where x_err 
